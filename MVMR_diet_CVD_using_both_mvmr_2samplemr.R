...
tb = read.table("/project/voight_T2D_UM1_FGP/diane531/Diet_CVD/MVMR_diet_CVD/single_tables_MR_info_table_phase3_cvd_endpoints_5mediators.txt",sep="\t",header=T)
...
#The 8 potential mediators are: "BMI", "DBP", "EA", "TG", "LDL"
...
output_dir = "/project/voight_T2D_UM1_FGP/diane531/Diet_CVD/MVMR_diet_CVD/"
